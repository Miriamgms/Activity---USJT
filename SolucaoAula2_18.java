...
public class SolucaoAula2_18 
{
    public static void main(String[] args) 
    {
        ...
        {
            JOptionPane.showMessageDialog(null, "Ordem crescente: " + primeiroNumero + ", " + segundoNumero);
        } 
        else 
        {
            JOptionPane.showMessageDialog(null, "Ordem crescente: " + segundoNumero + ", " + primeiroNumero);
        }
    }
}
